...
public class BuildArray {
     ...
     * "-
     * 
     * Formula para hacerlo inplace:
     * -" Valor Final = Cociente x Divisor + Resto "-
     * - Len es el Divisor.
     * - El Resto es el valor original, y se consigue asi: v % len.
     * - El Cociente es el nuevo valor, y se consigue asi: v / len.
     *
    *
     * @param nums
     * @return
    ...
    public int[] buildArray2(int[] nums) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            int newValue = nums[originalValue] % n;
